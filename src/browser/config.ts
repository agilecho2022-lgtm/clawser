import type { BrowserConfig, BrowserProfileConfig, ClawserConfig } from "../config/config.js";
 ...
 *
 * Note: this is a Clawser browser profile (routing config), not a Chrome user profile.
