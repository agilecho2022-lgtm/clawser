...
export function hasAmbiguousGatewayAuthModeConfig(cfg: ClawserConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: ClawserConfig): void {
