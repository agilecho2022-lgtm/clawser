...
function resolveResolutionLimits(config: ClawserConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: ClawserConfig): SecretProviderConfig {
